...
//#define BLACKBONE_DEVICE_NAME           L"DXGKrnl488"
//#define BLACKBONE_DEVICE_FILE           L"\\\\.\\" BLACKBONE_DEVICE_NAME

#define FILE_DEVICE_BLACKBONE           0x9075
...
#define IOCTL_OB_AUTH  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x900, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_OB_Driver_List  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x901, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_OB_Auth_Unload  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x902, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_REMOVE_LOAD_IMAGE_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x903, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_RESTORE_LOAD_IMAGE_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x904, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_REMOVE_PROC_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x905, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_RESTORE_PROC_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x906, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_REMOVE_THREAD_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x907, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_RESTORE_THREAD_NOTIFY   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x908, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_HIDE_WINDOW  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x909, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_EAC_BYPASS_SET  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x910, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_EAC_BYPASS_REMOVE  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x911, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_MOUSE_INPUT  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x912, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_KB_INPUT  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x913, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_SET_MEMCPY_PID  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x914, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_FAST_MEMCPY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x915, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_ADD_OB_PID  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x916, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_REMOVE_OB_PID  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x917, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_REMOVEALL_OB_PIDS  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x918, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_GETMEM_PROTECT  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x919, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_REDIRECT_DLL  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x920, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_STOP_REDIRECT_DLL  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x921, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_MODULE_BASE  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x922, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_DRIVER_NAME  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x923, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_ADD_PID_EXIT_MON  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x924, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_CHECK_PID_EXIT_MON  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x925, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_CHECK_PID_RUNNING  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x926, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_TERMINATE_PID  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x927, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_START_OBS  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x928, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_STOP_OBS  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x929, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_AK_START_SPOOFER  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x930, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_STOP_SPOOFER  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x931, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)

#define IOCTL_THG_MONO_REAL  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x947, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_SPOOF_MAC  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x948, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
#define IOCTL_AK_REMOVEALL_MAC_SPOOFS  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x949, METHOD_BUFFERED, FILE_READ_DATA|FILE_WRITE_DATA)
...
0
*/
#define IOCTL_BLACKBONE_DISABLE_DEP  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x932, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_SET_PROTECTION  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x933, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_GRANT_ACCESS   (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x934, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_COPY_MEMORY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x935, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
*/
#define IOCTL_BLACKBONE_ALLOCATE_FREE_MEMORY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x936, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_PROTECT_MEMORY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x937, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
*/
#define IOCTL_BLACKBONE_MAP_MEMORY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x938, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
*/
#define IOCTL_BLACKBONE_MAP_REGION  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x939, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_UNMAP_MEMORY  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x940, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
*/
#define IOCTL_BLACKBONE_UNMAP_REGION  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x941, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_HIDE_VAD  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x942, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_INJECT_DLL  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x943, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_MAP_DRIVER  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x944, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
0
*/
#define IOCTL_BLACKBONE_UNLINK_HTABLE  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x945, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
*/
#define IOCTL_BLACKBONE_ENUM_REGIONS  (ULONG)CTL_CODE(FILE_DEVICE_BLACKBONE, 0x946, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
